              ...
              <nav className="flex gap-2">
                {navLinks.map((link) => (
                  <a
                    ...
                    className={`text-sm font-medium px-4 py-2 rounded-full transition-all whitespace-nowrap flex items-center gap-2 ${activeSection === link.id
                ...
                <Link
                  ...
                  className={`text-sm font-medium px-4 py-2 rounded-full transition-all whitespace-nowrap ${activeSection === 'about'
                    ? 'bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 shadow-sm'
                    : 'text-gray-600 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-50 dark:hover:bg-gray-800/50'
                    }`}
                >
